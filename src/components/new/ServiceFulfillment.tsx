...
const ServiceFulfillment: React.FC = () => {
  ...
  const handleCancelFulfillment = () => {
    setFulfillmentStatus("failed");
    dispatch({ type: "COMPLETE_SERVICE", payload: false });
  };
    ...
    <div className="max-w-2xl mx-auto">
      ...
      {fulfillmentStatus === "completed" ? (
        ...
        <OTPValidation
          ...
          description={`Please enter the 6-digit OTP sent to the technician to confirm that the service ${state.selectedService.description} has been completed.`}
