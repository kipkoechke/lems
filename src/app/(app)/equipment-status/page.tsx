...
function EquipmentStatusContent() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: summary?.affected_equipment_count ?? 0,
      icon: FaCheckCircle,
      color: "text-green-600",
      bg: "bg-green-100",
    },
    {
      label: "Active Downtimes",
      value: summary?.active_downtimes_count ?? 0,
      icon: FaWrench,
    ...
    {
      label: "Avg Downtime",
      value: summary?.average_downtime_formatted ?? "0h",
      icon: FaTimesCircle,
      color: "text-red-600",
      bg: "bg-red-100",
    },
    {
      ...
      value: summary?.total_downtime_formatted ?? "0h",
      icon: FaClock,
