        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2 text-lg">Lot Number: {lot.number}</p>
            </div>
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-500 uppercase tracking-wide">Lot Name</label>
                <p className="text-lg font-medium text-gray-900">{lot.name}</p>
              </div>
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-500 uppercase tracking-wide">Lot Number</label>
                <p className="text-lg font-medium text-gray-900 font-mono bg-gray-50 px-3 py-1 rounded-lg inline-block">{lot.number}</p>
              </div>
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-500 uppercase tracking-wide">Status</label>
                <p className={`text-lg font-semibold ${lot.is_active === "1" ? "text-green-600" : "text-red-600"}`}>
                  {lot.is_active === "1" ? "Active" : "Inactive"}
                </p>
              </div>
              <div className="space-y-2">
          ...
          <div className="p-8">
            {services.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-lg">No services found for this lot</p>
              </div>
            ) : (
                      ...
                      <tr key={service.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-500 font-mono">Code: {service.code}</p>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <span 
          ...
          <div className="p-8">
            {contracts.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-lg">No contracts found for this lot</p>
              </div>
            ) : (
              <div className="overflow-hidden rounded-xl border border-gray-200">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {contracts.map((contract) => (
                      <tr key={contract.id} className="hover:bg-gray-50 transition-colors">
                        <td className="px-6 py-4">
                          <div>
                            <p className="text-sm font-semibold text-gray-900">{contract.vendor_name}</p>
                            <p className="text-sm text-gray-500 font-mono">Code: {contract.vendor_code}</p>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <div>
